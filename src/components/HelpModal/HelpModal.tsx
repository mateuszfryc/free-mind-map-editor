...
import { CloseButton, Flex, HelpModalWrapper, Title, TutorialGif, Paragraph } from './HelpModal.styled';

type HelpProps = {
    closeHelp: () => void;
};

export const HelpModal: React.FC<HelpProps> = ({ closeHelp }) => {
    return (
        <HelpModalWrapper>
            <CloseButton onClick={closeHelp} />
            <Flex width="100%" maxWidth="920px" padding="" column>
